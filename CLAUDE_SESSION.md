...
| Cardiac Arrest — Shockable (VF/VT) | ✅ Complete | `CardiacArrestShockableFlowchart.tsx` |
...
- EMT: Compressions (100–120/min, 200/round), AED, airway/ventilation mode decision
- Decision 1: Unwitnessed/special case? → immediate BVM vs. passive O₂ first (≥8 yrs)
- PARAMEDIC: IV/IO + monitor, defibrillate per monitor settings
...
- Torsades: Magnesium Sulfate 50 mg/kg IV/IO max 2 g over 5 min
- Reversible causes: Hypothermia, Hyperkalemia (Calcium Gluconate/Chloride), Hypovolemia, OD, Tension PTX
- Decision 2: ROSC? → YES: Post-Arrest/ROSC Care; NO: continue
- Decision 3: After 4 rounds no ROSC? → YES: TOR/transport; NO: loop back
- Left-side loop arrow back to Paramedic Step 7

---

## Remaining Build Tasks
1. Cardiac Arrest — Non-Shockable (Asystole/PEA) — RN v2
2. Replace Drug Reference with full 40-drug Red Book dataset
3. Verify Drug Calculation doses match Red Book
4. Fix Android nav bar covering bottom tabs
...
## Last Session
- April 17, 2026
- Generated `CardiacArrestShockableFlowchart.tsx` (VF/VT — RN v2 architecture)
- Updated workflow: Claude Code retired — Claude Chat generates files, drag & drop into project
